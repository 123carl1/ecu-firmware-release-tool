...
class HARDWARE_INFO(Structure):
    _fields_ = [
        ("McuModel", c_ubyte * 16),
        ("ProductModel", c_ubyte * 16),
        ("Version", c_uint),
        ("CANChannelNum", c_ubyte),
        ("LINChannelNum", c_ubyte),
        ("PWMChannelNum", c_ubyte),
        ("HaveCANFD", c_ubyte),
        ("DIChannelNum", c_ubyte),
        ("DOChannelNum", c_ubyte),
        ("HaveIsolation", c_ubyte),
        ("ExPowerSupply", c_ubyte),
        ("IsOEM", c_ubyte),
        ("EECapacity", c_ubyte),
        ("SPIFlashCapacity", c_ubyte),
        ("TFCardSupport", c_ubyte),
        ("ProductionDate", c_ubyte * 12),
        ("USBControl", c_ubyte),
        ("SerialControl", c_ubyte),
        ("EthControl", c_ubyte),
        ("VbatChannel", c_ubyte),
    ]
